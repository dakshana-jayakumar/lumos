...
- **Advanced Error Analysis Engine** with 50+ sophisticated error pattern types
  ...
  - JavaScript/TypeScript error analysis (ReferenceError, TypeError,
    SyntaxError)
...
#### 🎯 Surgical Precision Error Analysis
...
Releases are automated using `semantic-release` based on
...
For questions about releases or version compatibility, please open an issue or

  ...
  try {
    ...
    try {
      ...
      if (!options.overwrite) {
        ...
        console.log(
          chalk.gray('   • Use lumos utils config show to view current config')
        );
        console.log(
          chalk.gray('   • Use lumos utils config validate to check config')
        );
        return;
      }
    } catch {
...
function displayInitResults(
  ...
  console.log(
    chalk.green('   ✅ .env.example - Environment variables template')
  );
  console.log();
  ...
  console.log(
    chalk.gray(`   Coverage Threshold: ${config.testing.coverageThreshold}%`)
  );
  console.log(
    chalk.gray(`   Research Sources: ${config.research.sources.join(', ')}`)
  );
  console.log();
  ...
  console.log(
    chalk.gray('   • Use environment-specific overrides for dev/prod')
  );
  console.log(chalk.gray('   • Check the documentation for advanced features'));
  console.log(
    chalk.gray('   • Run lumos utils status to verify everything is working')
  );
}
